        ...
        if (widget.labelText != null)
          Row(
            children: [
              ...
              if (widget.requiredField!) Text('*', textAlign: TextAlign.center, style: KTextStyle.bodyText2.copyWith(color: KColor.red)),
            ],
          ),
        Container(
          width: MediaQuery.of(context).size.width * widget.widthFactor,
          padding: widget.hasPrefixIcon ? EdgeInsets.symmetric(horizontal: 4) : EdgeInsets.only(right: 0),
          ...
          child: TextFormField(
            ...
            style: KTextStyle.bodyText1.copyWith(color: widget.textColor ?? KColor.black),
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: widget.hasPrefixIcon ? Padding(padding: EdgeInsets.only(right: 5), child: widget.prefixIcon) : Container(width: 0),
              prefixIconConstraints: BoxConstraints(minHeight: widget.hasPrefixIcon ? 21 : 0),
              suffixIcon: widget.isPasswordField
                  ? obscureText()
                  : widget.isClearableField
                      ? clearField()
                      : widget.suffixIcon != null
                          ? InkWell(onTap: widget.suffixCallbackFunction, child: widget.suffixIcon)
                          : null,
            ),
            onTap: widget.onTap,
